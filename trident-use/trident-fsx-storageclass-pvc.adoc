...
=== Configurare un oggetto Kubernetes StorageClass
 ...
 https://kubernetes.io/docs/concepts/storage/storage-classes/["Oggetto Kubernetes StorageClass"^]Identifica Trident come provisioner utilizzato per la classe specifica a Trident come eseguire il provisioning di un volume. Ad esempio:
