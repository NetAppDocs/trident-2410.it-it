...
summary: Trident offre agli utenti Kubernetes la possibilità di espandere i propri volumi dopo che sono stati creati. Informazioni sulle configurazioni richieste per espandere i volumi iSCSI e NFS. 
---
= Espandere i volumi
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
Trident offre agli utenti Kubernetes la possibilità di espandere i propri volumi dopo che sono stati creati. Informazioni sulle configurazioni richieste per espandere i volumi iSCSI e NFS.
