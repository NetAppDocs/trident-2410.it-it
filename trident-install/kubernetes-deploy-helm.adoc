...
----
. Utilizzare `helm install` e specificare un nome per la distribuzione come nell'esempio seguente dove si trova `100.2404.0` la versione di Trident che si sta installando.
+
[listing]
----
